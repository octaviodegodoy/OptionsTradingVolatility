...
MIN_DAYS_TO_EXPIRY = 45*UNIX_DAYS_IN_SECONDS # 45 days in seconds
...
IV_DIFF_THRESHOLD_CALLS = 0.01 # Threshold for IV difference between call strikes to consider for trading
